    ...
    */
	...
	initRegisterForm() {
		this.registerForm = this.fb.group({
			...
			// stakeholder_bank: ['', Validators.compose([
			// 	Validators.required,
			// 	Validators.minLength(3),
			// 	Validators.maxLength(100)
			// ]),
			// ],
			stakeholder_university: ['', Validators.compose([
				Validators.required,
				Validators.minLength(3),
				Validators.maxLength(100)
			]),
	...
	submit() {
		...
		// _user.stakeholder_bank=controls.stakeholder_bank.value;
		_user.stakeholder_university=controls.stakeholder_university.value;
