...
db.account_applications = require('../model/account.model.js')(sequelize, Sequelize);
//db.auth = require('../model/auth.model.js')(sequelize,Sequelize);
db.employees = require('../model/employee.model.js')(sequelize, Sequelize);
db.clients = require('../model/client.model.js')(sequelize, Sequelize);
db.projects = require('../model/project.model.js')(sequelize, Sequelize);
db.invoices = require('../model/invoice.model.js')(sequelize, Sequelize);
db.jobportals = require('../model/jobportal.model.js')(sequelize,Sequelize);
db.timesheets = require('../model/timesheet.model.js')(sequelize,Sequelize);
