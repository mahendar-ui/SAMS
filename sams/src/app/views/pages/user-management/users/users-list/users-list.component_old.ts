...
// Services
import { LayoutUtilsService, MessageType, QueryParamsModel 
...
export class UsersListComponentOld implements OnInit, OnDestroy {
	// Table fields
	 ...
	 */
	ngOnInit() {
		const data = this.authService.getAllUsers().subscribe(
